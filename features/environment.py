...
#def browser_mobile_init(context):
    ...
    # bstack_options = {
    #     'platform': 'IOS',
    #     'deviceName': 'iPhone 13 Pro',  # Adjust device name as needed (e.g., iPhone 11, etc.)
    #     'osVersion': '15.0',  # Adjust iOS version as needed
    #     'browserName': 'Safari',  # Browser used on iPhone
    #     'sessionName': scenario_name,
    # }scenario_name
